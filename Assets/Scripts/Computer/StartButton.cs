...
public class StartButton : MonoBehaviour
{
    ...
    public void Forfeit()
    {
        if (gameStarted == true)
        {
            //player started the game and chose to quit
            print("Player started, and then quit");
            wls.addLose();
        }
        else
        {
            //player didn't start the game and chose to quit
            print("Player DID NOT start, and then quit");
