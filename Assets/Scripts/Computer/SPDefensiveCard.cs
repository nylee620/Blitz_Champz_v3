        ...
        if (tag != "discard")//makes sure the card is not discarded, you don't want to play cards from the discard pile
        {
            ...
            switch (firstLetter)//used to find which card was played last to determine if the card can block it. return if the card cannot.
            {
                case "r"://rushing td
                    ...
                    {
                        //block card
                        p.Messagetoconsole("You defended against the " + p.opponentsname + "'s touchdown!");
                    }
                    else
                    {
                        return;
                ...
                case "p"://passing td
                    ...
                    {
                        //block card
                        p.Messagetoconsole("You intercepted the " + p.opponentsname + "'s pass!");
                    }
                    else
                    {
                        return;
                ...
                case "c"://conversion
                    ...
                    {
                        p.Messagetoconsole("You blocked " + p.opponentsname + "'s Conversion!");
                        //block card
                    }
                    else
                    {
                ...
                case "f":
                    ...
                    {//when the player selects blocked kick card
                        //block card
                        p.Messagetoconsole("You Blocked " + p.opponentsname + "'s Kick");
                    }
                    else
                    {
                        return;
